...
public class Splashes {
    ...
    public static void initialize() {
        if (CottonTweaks.config.add_cotton_splashes) {
            addSplashes(
                    "It has been planted!",
                    "Fresh and organic!",
                    "Hello Fabric World!",
    ...
    public static String getRandomSplash(Random random) {
        ...
        if (CottonTweaks.config.prioritize_custom_splashes) {
            if (holidaySplashes.isEmpty()) {
                ...
                if (random.nextInt(CottonTweaks.config.custom_splash_priority) == 0) {
